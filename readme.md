...
- Speak naturally after the beep sound

### 4. Ending a Session
- Click "End Session" to securely save the conversation
...
This comprehensive README.md covers:
1. Project overview
2. System requirements
3. Step-by-step installation with venv setup
...
The manual guides users from initial setup through daily operation, with special attention to security best practices and troubleshooting common issues.